...
from keyboards.default.oyat_button import markup
...
async def bot_start(message: types.Message):
    ...
    await message.answer(f"Xush kelibsiz\! {make_title(full_name)}", parse_mode=types.ParseMode.MARKDOWN_V2,reply_markup=markup)
